...
To eliminate redundance, two optimizations are undertaken when storing tags:
...
to be identical no their neighbors.
- Takes are represented as integers, which are maps into a string table to
